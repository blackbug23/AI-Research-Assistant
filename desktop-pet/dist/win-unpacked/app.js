...
const mockDatabase = {
  ...
  insertGoodsData() {
    ...
    mockDatabase.inventory = [
      ...
      { id: 2, goods_id: 2, goods_name: '鼠标', current_quantity: 100, min_quantity: &value='50', max_quantity: 200, location: '仓库B', last_update: new Date().toISOString() },
